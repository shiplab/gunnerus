...
| File | Used for |
| --- | --- |
| `gunnerus-3d.png` | The 3D model render at the top of the main README. Rendered from the simplified web copy in [`../pages/assets/gunnerus.glb`](../pages/README.md), itself derived from the C-JOB 3D model. |
...
Same terms as the rest of the repository — CC BY-NC 4.0. See the main [README](../README.md#licence) and [LICENSE](../LICENSE).
